...
Deno.serve(async (req) => {
  try {
    ...
    // Payout tables — all ranks are fixed-odds, no progressives
    ...
    const RANK_FREQS = [0.054344, 0.195325, 0.177030, 0.235248, 0.281685, 0.071882];
    const RANK_PAYOUTS_ARR = [16.76, 3.95, 5.02, 3.10, 2.53, 12.43];
    const RANK_CUM = [];
    let _rc = 0;
    ...
    const STRATEGIES = [
      { name: 'Kind Combo', hands:[1,6], ranks:[5], colors:[], river:'strict4' },
      { name: "High Odd's", hands:[0,2,3,1], ranks:[0], colors:[], river:'strict4' },
      { name: 'Pair Combo', hands:[0,1], ranks:[0,1], colors:[], river:'strict4' },
      { name: 'Kind Combo 2', hands:[1,6], ranks:[5,2], colors:['3R','4R','3B','4B'], river:'strict4' },
      ...
      { name: 'Kind Combo 3', hands:[1,6], ranks:[5,2], colors:['3R','4R'], river:'strict4' },
      ...
      { name: 'Kind Combo 4', hands:[1,6], ranks:[5,2], colors:['3B','4B'], river:'none' },
      ...
      // Single Mix 1-30 (Two Pair only — One Pair removed 2026-04-14)
      ...
      { name: 'Rank High Odds 1', hands:[], ranks:[1,5], colors:['3R','4R','5R','3B','4B','5B'], river:'strict4' },
      { name: 'Rank High Odds 2', hands:[], ranks:[1,5], colors:['3R','4R','5R','3B','4B','5B'], river:'when3' },
      { name: 'Rank High Odds 3', hands:[], ranks:[1,5], colors:['3R','4R','5R','3B','4B','5B'], river:'random' },
      { name: 'Rank High Odds 4', hands:[], ranks:[1,5], colors:['3R','4R','5R','3B','4B','5B'], river:'none' },
      { name: 'Rank High Odds 5', hands:[], ranks:[1,5], colors:['3R','4R','3B','4B'], river:'strict4' },
      { name: 'Rank High Odds 6', hands:[], ranks:[1,5], colors:['3R','4R','3B','4B'], river:'when3' },
      { name: 'Rank High Odds 7', hands:[], ranks:[1,5], colors:['3R','4R','3B','4B'], river:'random' },
      { name: 'Rank High Odds 8', hands:[], ranks:[1,5], colors:['3R','4R','3B','4B'], river:'none' },
      { name: 'Rank High Odds 9', hands:[], ranks:[1,5], colors:['3R','3B'], river:'strict4' },
      { name: 'Rank High Odds 10', hands:[], ranks:[1,5], colors:['3R','3B'], river:'when3' },
      { name: 'Rank High Odds 11', hands:[], ranks:[1,5], colors:['3R','3B'], river:'random' },
      { name: 'Rank High Odds 12', hands:[], ranks:[1,5], colors:['3R','3B'], river:'none' },
      { name: 'Rank High Odds 13', hands:[], ranks:[1,5], colors:['3R'], river:'strict4' },
      { name: 'Rank High Odds 14', hands:[], ranks:[1,5], colors:['3R'], river:'when3' },
      { name: 'Rank High Odds 15', hands:[], ranks:[1,5], colors:['3R'], river:'random' },
      { name: 'Rank High Odds 16', hands:[], ranks:[1,5], colors:['3R'], river:'none' },
      { name: 'Rank High Odds 17', hands:[], ranks:[1,5], colors:['3B'], river:'strict4' },
      { name: 'Rank High Odds 18', hands:[], ranks:[1,5], colors:['3B'], river:'when3' },
      { name: 'Rank High Odds 19', hands:[], ranks:[1,5], colors:['3B'], river:'random' },
      { name: 'Rank High Odds 20', hands:[], ranks:[1,5], colors:['3B'], river:'none' },
      { name: 'Rank High Odds 21', hands:[], ranks:[1,5], colors:[], river:'strict4' },
      { name: 'Rank High Odds 22', hands:[], ranks:[1,5], colors:[], river:'when3' },
      { name: 'Rank High Odds 23', hands:[], ranks:[1,5], colors:[], river:'random' },
      { name: 'Rank High Odds 24', hands:[], ranks:[1,5], colors:[], river:'none' },
      // Color Board
      ...
      { name: 'Power Rank 1', hands:[], ranks:[5,4,2,1], colors:[], river:'none' },
      { name: 'Power Rank 2', hands:[], ranks:[5,4,2,1], colors:['3R','4R','5R','3B','4B','5B'], river:'none' },
      { name: 'Power Rank 3', hands:[], ranks:[5,4,2,1], colors:['3R','4R','3B','4B'], river:'none' },
      { name: 'Power Rank 4', hands:[], ranks:[5,4,2,1], colors:['3R'], river:'none' },
      { name: 'Power Rank 5', hands:[], ranks:[5,4,2,1], colors:['3B'], river:'none' },
      { name: 'Power Rank 6', hands:[], ranks:[5,4,2,1], colors:[], river:'strict4' },
      { name: 'Power Rank 7', hands:[], ranks:[5,4,2,1], colors:['3R','4R','5R','3B','4B','5B'], river:'strict4' },
      { name: 'Power Rank 8', hands:[], ranks:[5,4,2,1], colors:['3R','4R','3B','4B'], river:'strict4' },
      { name: 'Power Rank 9', hands:[], ranks:[5,4,2,1], colors:['3R'], river:'strict4' },
      { name: 'Power Rank 10', hands:[], ranks:[5,4,2,1], colors:['3B'], river:'strict4' },
      { name: 'Power Rank 11', hands:[], ranks:[5,4,2,1], colors:[], river:'when3' },
      { name: 'Power Rank 12', hands:[], ranks:[5,4,2,1], colors:['3R','4R','5R','3B','4B','5B'], river:'when3' },
      { name: 'Power Rank 13', hands:[], ranks:[5,4,2,1], colors:['3R','4R','3B','4B'], river:'when3' },
      { name: 'Power Rank 14', hands:[], ranks:[5,4,2,1], colors:['3R'], river:'when3' },
      { name: 'Power Rank 15', hands:[], ranks:[5,4,2,1], colors:['3B'], river:'when3' },
      { name: 'Power Rank 16', hands:[], ranks:[5,4,2,1], colors:[], river:'random' },
      { name: 'Power Rank 17', hands:[], ranks:[5,4,2,1], colors:['3R','4R','5R','3B','4B','5B'], river:'random' },
      { name: 'Power Rank 18', hands:[], ranks:[5,4,2,1], colors:['3R','4R','3B','4B'], river:'random' },
      { name: 'Power Rank 19', hands:[], ranks:[5,4,2,1], colors:['3R'], river:'random' },
      { name: 'Power Rank 20', hands:[], ranks:[5,4,2,1], colors:['3B'], river:'random' },
    ];
