        ...
        <div className="flex-1 flex flex-col gap-1.5 min-w-0 items-center">
          ...
          <div
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', userSelect: 'none' }}>
              <img src="https://media.base44.com/images/public/69f3a45ad82dff5b772d4de2/2667063a3_image.png" alt="Rapid Fire Texas Hold'em" style={{ width: '220px', height: 'auto', display: 'block', borderRadius: '12px', transform: 'translateY(-12px)' }} />
            </div>
